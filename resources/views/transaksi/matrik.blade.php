                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (Auth::user()->pengelola>4)
                                                    @if ($item->flag_trx < 7)
                                                    <button type="button" class="btn btn-primary btn-circle btn-sm" data-toggle="modal" data-target="#EditModal" data-trxid="{{$item->trx_id}}" data-kodetrx="{{$item->kode_trx}}" data-tglawal="{{$item->Matrik->tgl_awal}}" data-tglakhir="{{$item->Matrik->tgl_akhir}}"><span data-toggle="tooltip" title="Edit pengajuan transaksi dari {{$item->Matrik->UnitPelaksana->nama}}"><i class="fa fa-pencil"></i></span></button>
                                                    @endif
                                                @endif
                                            </td>
                                        </tr>
