                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="white-box">
                            ...
                            @else
                            <h3 class="box-title m-b-0">Form Matrik Perjalanan Multi Tujuan</h3>
                            <p class="text-muted m-b-30 font-13"> BPS Provinsi Nusa Tenggara Barat </p>

                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form method="POST" action="{{route('matrik.updatemulti') }}">
                                        @csrf
                                        @foreach ($MultiTujuan as $t)
                                            <div class="gruptujuan">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="input-group col-lg-8 col-sm-8 col-xs-12">
                                                        ...
                                                        <input type="text" class="form-control" id="nama_tujuan[{{$t->urutan_tujuan}}]" name="nama_tujuan[{{$t->urutan_tujuan}}]" placeholder="Tujuan" required readonly="" value="{{$t->namakabkota_tujuan}}">
                                                        <input id="kode_kabkota[{{$t->urutan_tujuan}}]" type="hidden" name="kode_kabkota[{{$t->urutan_tujuan}}]" value="{{$t->kodekab_tujuan}}" />
                                                    <span class="input-group-btn">
                                                        <button type="button" id="caritujuanmulti" class="btn waves-effect waves-light btn-success" data-idtujuan="{{$t->urutan_tujuan}}" data-toggle="modal" data-target="#CariTujuanMulti"><i class="fa fa-search"></i></button>
                                                    </span>
                                                    @if ($loop->first)
                                                    <span class="input-group-btn">
