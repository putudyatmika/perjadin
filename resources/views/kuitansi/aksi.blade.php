...
<a href="{{route('kuitansi.edit',$item->trx_id)}}" class="btn btn-success btn-rounded btn-sm" data-trxid="{{$item->Transaksi->trx_id}}" data-kodetrx="{{$item->Transaksi->kode_trx}}">Proses Pembayaran</a>
@endif
