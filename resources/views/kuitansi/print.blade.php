...
<html lang="en">
<head>
    <title>KUITANSI_{{strtoupper($data->peg_nama)}}_TRX_ID_{{$data->kode_trx}}</title>
...
.semuagaris td {  border: 1px solid black !important; }
...
<body>
    ...
    <main>
        <div class="halbox">
            @include('kuitansi.halaman1')
        </div>
        <div class="pindah-halaman"></div>
        <div class="halbox">
            @include('kuitansi.halaman2')
        </div>
        <div class="pindah-halaman"></div>
        <div class="halbox">
            @include('kuitansi.halaman3')
        </div>
    </main>
