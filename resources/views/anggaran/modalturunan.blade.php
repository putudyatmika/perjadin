...
<!--modal sync realisasi dgn rencana-->
<div class="modal fade" id="SyncRealisasiModal" tabindex="-1" role="dialog" aria-labelledby="SyncRealisasiModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="exampleModalLabel1">Sinkronisasi Realisasi dengan Rencana</h4> </div>
            <div class="modal-body">
                    <form method="POST" action="{{route('turunan.sinkronkan')}}">
                    @csrf
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            Semua realisasi menggunakan anggaran ini akan di sinkronkan ke pagu rencana
                        </div>
                    </div>                   
                    <input type="hidden" name="a_id" id="a_id" value="{{$dataAnggaran->id}}" />
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-inverse waves-effect waves-light" data-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Sinkron</button>
            </div>
        </form>
        </div>
    </div>
