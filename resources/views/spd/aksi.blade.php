...
<a href="{{route('spd.view',$item->Transaksi->kode_trx)}}" class="btn btn-rounded btn-primary btn-sm"><span data-toggle="tooltip" title="Cetak SPD an. {{$item->Transaksi->TabelPegawai->nama}}"><i class="fa fa-print"></i></span></a>
@endif
