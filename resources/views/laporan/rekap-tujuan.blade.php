...
<div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <h4 class="page-title">Laporan - Rekap Perjalanan Menurut Tujuan</h4>
                    </div>
                    <!-- /.page title -->
                    <!-- .breadcrumb -->
                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Laporan Rekap Tujuan</li>
                        </ol>
                    </div>
                    <!-- /.breadcrumb -->
                </div>
                                ...
                                <table class="table table-striped" id="DataTableCustom">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($rekapTujuan as $item)
                                            <tr>
                                                ...
                                                <td>
                                                        @if ($item->jumlah>0)
                                                        <a href="{{route('laporan.tujuan',$item->kode_kabkota)}}">{{$item->nama}}</a>
                                                        @else
                                                        {{$item->nama}}
                                                        @endif
                                                </td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class="text-right">{{$total_jumlah}}</th>
