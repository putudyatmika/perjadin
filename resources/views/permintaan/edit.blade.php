                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="input-group col-lg-2 col-sm-2 col-xs-12">
                                                ...
                                                <select class="form-control" name="ttd_kepala" id="ttd_kepala" required="">
                                                    ...
                                                    @for ($i = 0; $i < 4; $i++)
                                                    <option value="{{ $i }}" @if ($dataFormJln->ttd_flag_kepala_permintaan == $i)
                                                        selected="selected"
                                                    @endif>{{ $FlagTTD[$i] }}</option>
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="input-group col-lg-6 col-sm-6 col-xs-12">
                                                <select class="form-control" name="ttd_kepala_nip" id="ttd_kepala_nip" required="">
                                                    ...
                                                    @foreach ($dataTtd as $peg)
                                                       <option value="{{$peg->nip_baru}}" @if ($peg->nip_baru == $dataFormJln->ttd_kepala_nip_permintaan)
                                                        selected
                                                       @endif>{{$peg->nama}}</option>
                                                    @endforeach
                                                </select>
                                                <input type="hidden" id="ttd_kepala_nama" name="ttd_kepala_nama" value="{{$dataFormJln->ttd_kepala_nama_permintaan}}">
                                                <input type="hidden" id="ttd_kepala_jabatan" name="ttd_kepala_jabatan" value="{{$dataFormJln->ttd_jabatan_kepala_permintaan}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="input-group col-lg-8 col-sm-8 col-xs-12">
                                                ...
                                                <select class="form-control" name="ttd_ppk_nip" id="ttd_ppk_nip" required="">
                                                    ...
                                                    @foreach ($dataPPK as $peg)
                                                       <option value="{{$peg->nip_baru}}" @if ($peg->nip_baru == $dataFormJln->ttd_ppk_nip_permintaan)
                                                        selected
                                                       @endif>{{$peg->nama}}</option>
                                                    @endforeach
                                                </select>
                                                <input type="hidden" id="ttd_ppk_nama" name="ttd_ppk_nama" value="{{$dataFormJln->ttd_ppk_nama_permintaan}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="input-group col-lg-8 col-sm-8 col-xs-12">
                                                ...
                                                <select class="form-control" name="ttd_unitkerja_nip" id="ttd_unitkerja_nip" required="">
                                                    ...
                                                    @foreach ($dataTTDunitkerja as $ttdunit)
                                                       <option value="{{$ttdunit->nip_baru}}" @if ($ttdunit->nip_baru == $dataFormJln->ttd_nip_permintaan)
                                                            selected="selected"
                                                       @endif>[{{$ttdunit->unitkerja}}] {{$ttdunit->nama}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
